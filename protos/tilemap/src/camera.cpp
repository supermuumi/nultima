...
// BEGIN SHAMELESS COPY
// frustum culling copied from
// http://www.crownandcutlass.com/features/technicaldetails/frustum.html
// - originally by Mark Morley
...
/*
float Camera::sphereInFrustum( float x, float y, float z, float radius )
{
   int p;
   float d;
...
// END SHAMELESS COPY - thanks Mark!
